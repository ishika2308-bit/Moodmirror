      ...
      >
        ...
        <motion.div
          ...
          initial={{ 
            ...
            width: introStage === 'assembling' ? '85px' : '105px', 
            height: introStage === 'assembling' ? '85px' : '105px',
            left: 0,
            top: '25px'
          }}
          animate={
            isTransitioning 
              ? { scale: 1.1, width: '125px', height: '125px', x: 25, y: 5, background: colorLoop1[0] } 
              : { 
                  background: introStage === 'assembling' ? colorLoop1[0] : colorLoop1,
                  y: introStage === 'done' ? [0, -6, 0] : 0,
        ...
        >
          {/* Glossy highlight */}
          <div className="absolute top-2 left-3 w-8 h-4 bg-white rounded-full rotate-[-30deg] blur-[1px] opacity-60 mix-blend-overlay" />
        </motion.div>
        ...
        <motion.div
          ...
          initial={{ 
            ...
            width: introStage === 'assembling' ? '50px' : '70px', 
            height: introStage === 'assembling' ? '50px' : '70px',
          ...
          animate={
            isTransitioning 
              ? { scale: 1, width: '70px', height: '70px', top: '50%', right: '50%', x: 40, y: -50, background: colorLoop2[0] } 
              : { 
                  background: introStage === 'assembling' ? colorLoop2[0] : colorLoop2,
                  opacity: 1,
                  y: introStage === 'done' ? [0, 5, 0] : 0,
                  x: 0,
        ...
        >
          {/* Glossy highlight */}
          <div className="absolute top-1.5 left-2 w-5 h-2.5 bg-white rounded-full rotate-[-30deg] blur-[1px] opacity-60 mix-blend-overlay" />
        </motion.div>
        ...
        <motion.div
          ...
          initial={{ 
            ...
            width: introStage === 'assembling' ? '25px' : '35px',
            height: introStage === 'assembling' ? '25px' : '35px',
            opacity: introStage === 'assembling' ? 0 : 1,
            right: '15px',
            bottom: '25px'
          }}
          animate={
            isTransitioning 
              ? { scale: 1, width: '35px', height: '35px', bottom: '50%', right: '50%', x: 50, y: 10, background: colorLoop3[0] } 
              : { 
                  background: introStage === 'assembling' ? colorLoop3[0] : colorLoop3,
                  opacity: 1,
                  y: introStage === 'done' ? [0, -4, 0] : 0,
                  x: 0,
        ...
        >
          {/* Glossy highlight */}
          <div className="absolute top-1 left-1.5 w-3 h-1.5 bg-white rounded-full rotate-[-30deg] blur-[0.5px] opacity-60 mix-blend-overlay" />
        </motion.div>
      </motion.div>
    </motion.div>
  );
